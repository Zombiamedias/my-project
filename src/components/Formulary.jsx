...
const Formulary = memo(() => {
  return (
    <section className="flex flex-col left-0 top-  p-8 m-2 w-40% h-2/4 rounded-md  text-white border-2 border-blue-950 bg-[#1cb5e0] z-20 max-h-50dvh z-20">
      ...
      >
        <ul className="flex flex-col space-y-4 p-4  bg-transparent w-full h-full content-around"> 
          <li className="w-auto ">    
            ...
            <input type="text" className=" bg-transparent border-b-2 text-white"/>
          </li>
          <li className="w-auto">
          ...
          <li className="w-auto">
            ...
            <input type="email" className=" bg-transparent border-b-2 text-white"/>
          </li>
          <li className="w-auto">
            <label htmlFor="" className="w-[72px]  text-bold inline px-2 text-start">Telefono</label>
            <input type="phone" className=" bg-transparent border-b-2 text-white"/>
          </li>
          <li className="w-auto">
            <label htmlFor="" className="w-[72px]  text-bold inline px-2 text-start"></label>
            <input type="select" className=" bg-transparent border-b-2 text-white"/>
          </li>
